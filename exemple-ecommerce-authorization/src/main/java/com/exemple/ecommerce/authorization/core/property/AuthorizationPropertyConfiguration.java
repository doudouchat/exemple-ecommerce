package com.exemple.ecommerce.authorization.core.property;
...
public class AuthorizationPropertyConfiguration {
    ...
    public static final String JNDI_NAME = "java:comp/env/exemple-ecommerce-authorization-configuration";
