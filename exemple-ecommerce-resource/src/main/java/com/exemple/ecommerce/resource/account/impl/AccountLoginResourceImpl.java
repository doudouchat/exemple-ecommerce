...
@Service
@Validated
public class AccountLoginResourceImpl implements AccountLoginResource {

    private static final Logger LOG = LoggerFactory.getLogger(AccountLoginResourceImpl.class);
    ...
    public AccountLoginResourceImpl(Session session, LoginStatement loginStatement, AccountResource accountResource,
    ...
    @Override
    public void save(UUID id, JsonNode source) throws AccountLoginResourceExistException {
    ...
    private void save(UUID id, String login, JsonNode loginData) throws AccountLoginResourceExistException {
        ...
        if (!notExistLogin) {
            throw new AccountLoginResourceExistException(resultLogin.getString(1));
        }
    }

    private void save(Stream<String> stream, UUID id, JsonNode loginData) throws AccountLoginResourceExistException {

        List<AccountLoginResourceExistException> exceptions = new ArrayList<>(1);
    ...
    @Override
    public void update(UUID id, JsonNode source) throws AccountLoginResourceException {
