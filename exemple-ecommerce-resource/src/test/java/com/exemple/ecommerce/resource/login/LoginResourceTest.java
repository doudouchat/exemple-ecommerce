...
public class LoginResourceTest extends AbstractTestNGSpringContextTests {
    ...
    @Test
    public void save() throws LoginResourceException {
    ...
    public void get() {
        ...
        JsonNode login0 = resource.get(id.toString()).get();
        ...
        JsonNode login1 = resource.get((String) login.getEmail()).get();
        ...
        JsonNode login2 = resource.get((String) login.getLastname()).get();
    ...
    public void update() throws LoginResourceException {
    ...
    public void saveFailureLoginExist(String property) throws LoginResourceException {
    ...
    @Test
    public void saveAfterFailureLoginExist() throws LoginResourceException {
    ...
    @Test
    public void updateFailureLoginExist() throws LoginResourceException {
    ...
    public void saveFailure(String property, Object value) throws LoginResourceException {
    ...
    public void saveFailure() throws LoginResourceException {
