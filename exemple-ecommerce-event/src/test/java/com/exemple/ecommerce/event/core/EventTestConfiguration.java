package com.exemple.ecommerce.event.core;
...
@Configuration
public class EventTestConfiguration extends EventConfiguration {
    ...
    public static PropertySourcesPlaceholderConfigurer propertyPlaceholderConfigurer() {
        ...
        properties.setResources(new ClassPathResource("exemple-ecommerce-event-test.yml"));
