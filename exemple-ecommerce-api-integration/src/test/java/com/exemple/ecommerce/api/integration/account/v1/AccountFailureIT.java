...
import static com.exemple.ecommerce.api.integration.account.v1.AccountNominalIT.ACCESS_TOKEN;
...
import static com.exemple.ecommerce.api.integration.account.v1.AccountNominalIT.ID;
...
public class AccountFailureIT extends AbstractTestNGSpringContextTests {
    ...
    @Test(dataProvider = "createFailure", dependsOnMethods = "com.exemple.ecommerce.api.integration.account.v1.AccountNominalIT.connexion")
    ...
    public void createSchemaFailure() {
        ...
        headers.put("Authorization", Collections.singletonList("Bearer " + ACCESS_APP_TOKEN));
    ...
    @Test(dataProvider = "updateFailure", dependsOnMethods = "com.exemple.ecommerce.api.integration.account.v1.AccountNominalIT.updateSuccess")
    ...
    @Test(dependsOnMethods = "com.exemple.ecommerce.api.integration.account.v1.AccountNominalIT.updateSuccess")
    ...
    @Test(dependsOnMethods = "com.exemple.ecommerce.api.integration.account.v1.AccountNominalIT.connexionSuccess")
